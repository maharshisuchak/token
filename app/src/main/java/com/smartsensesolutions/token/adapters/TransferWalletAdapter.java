...
public class TransferWalletAdapter extends BaseAdapter {
    Context context;
    ArrayList<String> title;
    ArrayList<String> value;
    LayoutInflater inflter;

    public TransferWalletAdapter(Context applicationContext, ArrayList<String> title, ArrayList<String> value) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.row_spinner_transfer_wallet, null);
